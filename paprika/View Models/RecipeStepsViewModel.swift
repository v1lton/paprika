...
extension RecipeStepsView {
    class ViewModel: ObservableObject {
        @Published var recipeSteps = [
            ["Passo 1 de 9", "Numa tigela pequena misture o fermento e o açúcar com ¼ de xícara (chá) do leite morno até dissolver. Deixe descansar por cerca de 5 minutos, até começar a espumar."],
            ["Passo 10 de 15", "Numa tigela grande, misture a farinha com o sal. Acrescente a batata-doce e misture bem. Abra um buraco no centro e junte o fermento dissolvido. Numa tigela pequena quebre 1 ovo e então junte aos ingredientes – se ele estiver estragado você não perde a receita. Misture com uma espátula, do centro para a borda, para incorporar. Acrescente o restante do leite morno aos poucos, misturando bem com a mão."],
