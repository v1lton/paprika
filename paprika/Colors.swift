...
extension Color{
    public static let primitiveBlack: Color = Color(#colorLiteral(red: 0.12156862765550613, green: 0.11764705926179886, blue: 0.11372549086809158, alpha: 1))
    ...
    public static let primitive600:   Color = Color(#colorLiteral(red: 0.32156863808631897, green: 0.3137255012989044, blue: 0.30980393290519714, alpha: 1))
    ...
    public static let primitive400:   Color = Color(#colorLiteral(red: 0.6700000166893005, green: 0.6599500179290771, blue: 0.6566000580787659, alpha: 1))
    ...
    public static let primitive200:   Color = Color(#colorLiteral(red: 0.8980392217636108, green: 0.886274516582489, blue: 0.8784313797950745, alpha: 1))
    public static let primitive100:   Color = Color(#colorLiteral(red: 0.9490196108818054, green: 0.9411764740943909, blue: 0.9411764740943909, alpha: 1))
    public static let primitive50:    Color = Color(#colorLiteral(red: 0.9882352948188782, green: 0.9783529043197632, blue: 0.968470573425293, alpha: 1))
    public static let primitiveWhite: Color = Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))
    ...
    public static let brandPrimary400: Color = Color(#colorLiteral(red: 0.699999988079071, green: 0.17500001192092896, blue: 0.27086952328681946, alpha: 1))
    ...
    public static let brandPrimary50:  Color = Color(#colorLiteral(red: 0.9700000286102295, green: 0.8730000257492065, blue: 0.8907833099365234, alpha: 1))
    ...
    public static let brandSecondary400: Color = Color(#colorLiteral(red: 0.800000011920929, green: 0.33000001311302185, blue: 0.19999998807907104, alpha: 1))
    ...
    public static let negativeFeedback700: Color = Color(#colorLiteral(red: 0.550000011920929, green: 0.027500033378601074, blue: 0.027500033378601074, alpha: 1))
    ...
    public static let negativeFeedback50:  Color = Color(#colorLiteral(red: 0.9900000095367432, green: 0.8414999842643738, blue: 0.8414999842643738, alpha: 1))
    
    public static let positiveFeedback800: Color = Color(#colorLiteral(red: 0.052499979734420776, green: 0.30000001192092896, blue: 0.030000001192092896, alpha: 1))
    ...
    public static let positiveFeedback50:  Color = Color(#colorLiteral(red: 0.8721999526023865, green: 0.9800000190734863, blue: 0.8623999953269958, alpha: 1))
    ...
    public static let alertFeedback700: Color = Color(#colorLiteral(red: 0.6000000238418579, green: 0.4545000195503235, blue: 0.018000006675720215, alpha: 1))
    ...
    public static let alertFeedback50:  Color = Color(#colorLiteral(red: 0.9900000095367432, green: 0.9528750777244568, blue: 0.8414999842643738, alpha: 1))
}
